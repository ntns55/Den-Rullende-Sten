...
\FrontFeatureImage
  {assets/royal/front-den-roede-trone-v2.png}
...
\input{royal-family.tex}

% ============================================================
% INTERVIEW MED SØLVRAVNENS PRÆST
% ============================================================
...
\headline{HVAD VIL DET SIGE\\ AT FØLGE SØLVRAVNEN?}

\par\medskip

\deck{Celina, Sølvravnen, er blandt de nyeste guder i Kalish. 
Men hvad betyder hendes ophøjelse egentlig for dem, der vælger at følge hende? 
Gert Günther Gammelgaard har talt med en af hendes nye præster.}
...
\lettrine[lines=2,lhang=0.1,loversize=0.05]{D}{er}
er ikke gået lang tid, siden Celina Coco blev ophøjet og tog navnet Sølvravnen. 
Alligevel er de første præster allerede begyndt at samle sig omkring hendes lære.

Jeg satte mig derfor ned med en af dem for at stille det måske mest oplagte spørgsmål:

\medskip

\textbf{Gert Günther Gammelgaard: Hvis du skulle forklare Sølvravnen til én, der aldrig havde hørt om hende før, hvad ville du så sige?}

\textit{Præsten:} At hun er en gud for omsorg. Men omsorg skal forstås som mere end venlige ord. 
Det handler om at hjælpe de mennesker, der står omkring dig. Din familie, dine venner, dit folk. 
Hvis nogen falder, hjælper du dem op.

\medskip

\textbf{Men skal man så hjælpe alle?}

Man skal hjælpe, hvor man kan. Men Sølvravnen forventer ikke, at du ødelægger dig selv for fremmede, mens dine egne lider.

Omsorg begynder tæt på dig.

\begin{pullquote}
``Omsorg er ikke noget, du siger. Det er noget, du gør.''
\end{pullquote}

\textbf{Celina havde selv et noget... anstrengt forhold til penge. Hvordan passer det sammen med hendes lære?}

Præsten ler.

Det gør det måske netop meget godt.

Hun kendte værdien af en mønt, fordi hun ofte manglede dem. Hun vidste også, hvad det betød at skylde andre noget.

Gæld handler ikke kun om penge. Hvis nogen har hjulpet dig, så husker du det. Hvis du giver dit ord, så holder du det.

\medskip

\textbf{Så rigdom er forkert?}

Overhovedet ikke. Rigdom kan bruges til meget godt.

Men hvis du har et fyldt bord, mens dine nærmeste sulter, så har du misforstået noget.

\medskip

\textbf{Musik og natur nævnes også ofte sammen med Sølvravnen. Hvorfor?}

Fordi livet ikke kun handler om at overleve.

En sang, et godt måltid, en aften omkring et bål eller en vandring gennem skoven kan være lige så vigtig for et menneske som mønter.

Glæde er også noget, vi giver til hinanden.

\medskip

\textbf{Hvis nogen læser dette og overvejer at følge Sølvravnen, hvad skal de så gøre?}

Præsten tænker et øjeblik.

``Begynd med den næste person, der har brug for dig.''

\separator

\clearpage
\includegraphics[width=1\textwidth]{Drakka.png}
\includegraphics[width=1\textwidth]{Dværgesprit.png}
