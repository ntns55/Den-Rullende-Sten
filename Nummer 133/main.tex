...
\FrontFeatureImage{Esselaia.png}
{ESSELAIA DØD!}
{FREDENS GUDINDE DRÆBT!}
...
\par\medskip
\headline{ESSELAIA DØD!}
\par\medskip
\deck{Fredens gudinde er faldet}
\par\medskip
\byline{Redaktionen}
\medskip

\lettrine[lines=3,lhang=0.1,loversize=0.05]{E}{sselaia} er død. Fredens, naturens og dragernes gudinde er blevet dræbt af Sortelverne. Ifølge de første beretninger blev de frygtede Gudesten brugt til drabet. Det er de samme kræfter, som tidligere blev brugt til at dræbe Daikia.

\par\medskip

Esselaia var engang et menneske og en druide, der kom til A'kastin efter Almans død. Hendes mantra gik på fred, kærlighed og forståelse, selv mellem gamle fjender. Hvor andre så had og krig, forsøgte hun at finde balance.

\par\medskip

Da Alman faldt, mistede naturen sin beskytter. Den Vandrende ophøjede derfor Esselaia til gudinde, så hun kunne hjælpe med at genoprette balancen. Siden blev hun kendt som Dragernes dronning og Den Barmhjertige.

\par\medskip

Hendes død betyder mere end tabet af en gudinde. Druiderne har mistet deres beskytter. Morwen har mistet den gudinde, hun dømte de døde sammen med. Dragerne har mistet deres dronning. Og Kalish har mistet en af de få guder, der ønskede fred. Det bør nævnes at alle sjæle blev hjulpet af Esselaia, med undtagelse af Sortelverne, hvis sjæle blev hjulpet af den Sorte Ilsher.

\par\medskip

Men de værste rygter handler ikke om hendes død. De handler om det, der kommer efter.

\par\medskip

Flere kilder frygter nu, at Esselaia ikke er forsvundet. I stedet siges det, at hun er blevet korrupteret og genfødt i dæmonernes sfære som Ærkedæmonen for Krig.

\par\medskip

Ingen ved endnu, hvad dette vil betyde for Kalish. Vil dragerne følge hende? Vil naturen vende sig mod folk? Vil guderne gå i krig?

\par\medskip

Ét er sikkert: En Ulykke kommer sjældent alene.


\section*{Nyheder}

\subsection*{Drage æg forsvundet!}
Vi har tidligere rapporteret omkring drageæget i Salezstad's zoologisk have! Men det er nu forsvundet! Ingen ved hvor det blev af, og mange mener at dette skyldes Esselaia's død.
...
\end{figure}
\par\medskip
\textbf{\Large 7. Morwen - Dødens Dronning}
\par
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Morwen's Symbol}
\end{figure}
\par\medskip
\textbf{\Large 6. Ewen - Visdommens Herre}
\par
...
\textbf{\Large 5. Raffael Moordet - Skyggernes Fyrste}
\par
...
\textbf{\Large 4. Orlek - Krigens Brøl}
\par
...
Den nyligt dræbte gudinde for drager, kærlighed, fred og elementerne. Hun tror på fred, forståelse og at selv gamle fjender kan finde fælles grund.
...
\subsection*{Dyrevelfærdslov III: Om drager, drageæg og relaterede problemer}

\paragraf{1} Efter de seneste hændelser i Salezstad er al privat opbevaring, flytning, udklækning eller handel med drageæg forbudt uden kejserlig tilladelse.

\paragraf{2} Enhver borger, der finder et drageæg, skal:
\begin{itemize}
  \item ikke røre det,
  \item ikke sælge det,
  \item ikke tilbede det,
  \item straks kontakte myndighederne.
\end{itemize}
...
\subsection*{Handelslov XIV: Om Handelskompagniets private valutaer}

\paragraf{1} Handelskompagni Guld, herefter omtalt som HKG, må ikke præsenteres som kejserlig mønt (Fjend).

\paragraf{2} Alle kompagnier, laug og private handelsordninger skal tydeligt oplyse, om en betaling kan bruges til at købe brød og betale skat.

\paragraf{3} Handelskompagniet kan forsat godt betale medarbejdere I HKG, da det anses som værende arbejderens eget ansvar at efterspørge betaling de kan bruge til at betale skat.

\paragraf{4} Overtrædelse straffes med bøde i rigtig valuta.
...
\end{figure}
\newpage
\section*{Dødsannoncer}

\begin{center}
\textbf{\Large ESSELAIA}\\
Fredens Vogter. Naturens milde hånd. Dragernes Dronning.\\
Tidligere menneske, senere gudinde, nu savnet af alle der troede, at Kalish stadig kunne vælge fred.\\[0.5em]
\textit{Blomster frabedes. Plant et træ. Beskyt et æg. Tilgiv en fjende, hvis det stadig er muligt.}
\end{center}

\separator

\begin{center}
\textbf{Ukendt sortelver}\\
Fundet i nærheden af noget, der muligvis var en drage.\\
Identifikation vanskeliggjort af varme, tænder og rimelig konsekvens.\\[0.5em]
\textit{Ingen pårørende har ønsket kontakt med redaktionen.}
\end{center}


\section*{Horoskop \& Varsler}

\subsection*{Ugens tegn efter Esselaias fald}

\textit{Udarbejdet af Madame Yrla, statsautoriseret varseltolker, tidligere ansat ved en kro nær A'kastin. Redaktionen gør opmærksom på, at horoskoper ikke er juridisk bindende.}

\par\medskip

\textbf{Dragen}\\
Du føler dig forladt, vred og usikker på, hvem der nu bestemmer. Undgå åbne marker, sortelvere.

\par\medskip

\textbf{Hammeren}\\
Loven står stærkt i dit tegn. Det samme gør hårdt arbejde, tunge sten og præster med lister over arbejdsopgaver. En mulighed åbner sig ved Sydporten.

\par\medskip

\textbf{Pennen}\\
Du bør passe på med, hvad du skriver denne uge. Et ord kan blive misforstået, et brev kan blive opsnappet, og en sætning kan måske ændre virkeligheden.

\par\medskip

\textbf{Ravnen}\\
Hemmeligheder kredser om dig. Du vil høre noget ved hoffet, som du ikke burde vide. Hvis det handler om Den Røde Trone, bør du ikke gentage det højt.

\par\medskip

\textbf{Knoglen}\\
Morwen holder øje med dig. Det er ikke nødvendigvis dårligt. Hun holder øje med alle til sidst. Gamle sager vender tilbage, især gæld, løfter og afdøde slægtninge.

\par\medskip

\textbf{Mønten}\\
Handelskompagniet smiler til dig. Dette er ikke et godt tegn. Du kan tjene penge denne uge, men læs alt med småt. Kongetand bør ikke betragtes som en stabil pensionsordning.

\par\medskip

\textbf{Egen}\\
Naturen hvisker, men ikke på en betryggende måde. Druiderne er uenige, træerne er urolige, og Fyrnos virker vred. Plant noget ellers vil du selv blive plantet.

\par\medskip

\textbf{Øksen}\\
Orlek står stærkt i dit tegn, hvilket betyder energi og mod. Ugens råd: Ikke alle problemer bliver mindre af at blive slået.

\par\medskip

\textbf{Skyggen}\\
Raffael Moordet lover dig en genvej. Den virker. Det er problemet. Undgå mørke aftaler og låste døre.

\par\medskip

\textbf{Flammen}\\
Fyrnos varsler fornyelse, varme og mulig brand. Gode nyheder kan opstå af aske.

\par\medskip

\textbf{Bølgen}\\
Undine trækker i dig. Følelserne står højt, især sorg og vrede. Drik vand. Undgå profetier.

\par\medskip

\textbf{Stenen}\\
Terran giver dig stabilitet. Desværre betyder stabilitet i denne uge sandsynligvis, at du bliver sat til at bære byggematerialer ved Sydporten. Stå fast.
